    ...
    <div class="mb-5 w-100 d-flex justify-content-center" v-if="work">
        <div class="review" v-if="!editMode">
            <div class="d-flex review_data">
                <div>
                    <div class="d-flex review_data_info">
                        <div class="review_data_info-name">
                            {{ item.author }}
                        </div>
            ...
            <div class="category_card_functions">
                <div
                    class="category_card_functions-circle"
        ...
        <div class="review" v-if="editMode">
            <div class="d-flex review_data">
                <div>
                    <div
                        class="d-flex review_data_info d-flex align-items-center mb-2"
                    >
                        <input
                            type="text"
                            class="review_data_info-name main_input"
                            v-model="item.author"
                        />
                        <div class="ml-3 review_data_info-date">{{ date }}</div>
                    </div>
                    <div class="review_data_stars d-flex align-items-center">
                        <span>Рейтинг:</span>
                        <input
                            class="ml-3 main_input main_input_40 main_input_center"
                            v-model="item.rating"
                        />
                    </div>
                </div>
